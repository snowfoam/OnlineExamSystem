			...
			<div class="test">
				<form action="" method="post">
					<div class="test_title">
						...
						<font><input type="button" disabled="disabled" style="background-color:#e4e4e4;" name="test_jiaojuan" value="Submit"></font>
					</div>
									...
									<li id="qu_${singleQuestion }_${sq.question.id}" data-key="${sq.id}">
										...
										<div class="test_content_nr_main">
											<ul>
													...
													<li class="option" data-type="single" data-value="D">
														<label style="color:red;">correct answer：${sq.question.answer }</label>
													</li>
											</ul>
										</div>
									</li>
									...
									<li id="qu_${muiltQuestion }_${mq.question.id}" data-key="${mq.id}">
										...
										<div class="test_content_nr_main">
											<ul>
													...
													<li class="option" data-type="single" data-value="D">
														<label style="color:red;">correct answer：${mq.question.answer }</label>
													</li>
											</ul>
										</div>
									</li>
									...
									<li id="qu_${chargeQuestion }_${cq.question.id}" data-key="${cq.id}">
										...
										<div class="test_content_nr_main">
											<ul>
													...
													<li class="option" data-type="single" data-value="D">
														<label style="color:red;">correct answer：${cq.question.answer }</label>
													</li>
											</ul>
										</div>
									</li>
