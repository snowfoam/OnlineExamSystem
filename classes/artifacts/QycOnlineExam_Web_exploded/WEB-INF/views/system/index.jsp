...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
    	<div class="wu-header-left">
        	<h1>Online Exam Background Management System</h1>
        </div>
        <div class="wu-header-right">
        	<p><strong class="easyui-tooltip" title="0 unread messages">${role.name}:${admin.username}</strong>，Welcome!</p>
            <p><a href="../home/user/index" target="_blank">Home Page</a>|<a href="logout">Log Out</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
	<div class="wu-sidebar" style="width:200px;" data-options="region:'west',split:true,border:true,title:'Navigation Menu'"> 
    ...
    <!-- end of sidebar -->    
    <!-- begin of main -->
    <div class="wu-main" data-options="region:'center'" style="width:1500px;">
        <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
            <div title="Home" data-options="href:'welcome',closable:false,iconCls:'icon-tip',cls:'pd3'"></div>
        </div>
    </div>
    <!-- end of main --> 
