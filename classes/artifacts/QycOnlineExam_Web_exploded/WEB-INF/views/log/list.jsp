...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>Log Content:</label><input id="search-name" class="wu-text" style="width:100px">
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'content',title:'Log Content',width:100,sortable:true},
