...
<%@include file="common/header.jsp"%>
	<style>
		.tm_login_body{
			background:url('../resources/home/images/login.jpg');
		...
		.tm_login_foot{ width:100%; line-height:30px; text-align:center; clear:both; margin:20px 0}
			...
			<div class="tm_login_title">
				<table border="0" cellpadding="0" cellspacing="0" class="tm_login_title_table">
					...
					<tr>
						...
						<td><span>Online Exam System</span></td>
					</tr>
				</tbody></table>
			</div>
                ...
                <tr>
                    ...
                    <td>
						<div style="margin-top:10px">
							<button type="button" class="tm_btn tm_btn_primary" style="width:45%" onclick="tm.doLogin();">Log in</button>
							<button type="button" class="tm_btn" onclick="tm.goRegister();" style="width:45%">Register</button>
						</div>
                    </td>
                </tr>
                <tr>
	...
	<script type="text/javascript">
		...
		function checkBrowser(){
			...
			if(!isSupportedBrowser){
				layer.open({
					title:"Browser tips", 
					content:"For best results, please use Chrome, FireFox, or 360 browser to access the system.",
					btnAlign: "c"
				});
			}
		}
